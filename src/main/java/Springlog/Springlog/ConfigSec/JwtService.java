...
public class JwtService {
    ...
    public String generateToken(
            ...
            UserDetails userDetails //from springframework!
    ){
        return Jwts
                .builder()
                ...
                .setExpiration(new Date((System.currentTimeMillis()+1000 * 60 * 24))) //remb me
    ...
    private boolean isTokenExpired(String token) {
        return extractExpiration(token).before(new Date()); //today date
    }
